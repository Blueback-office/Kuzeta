...
class StockLandedCostLine(models.Model):
    ...
    split_method = fields.Selection(help="Equal : Cost will be equally divided.\n"
...
class StockLandedCost(models.Model):
    ...
    def get_valuation_lines(self):
        ...
        for rec in result:
            ...
            print("//////////////////////", stock_move_obj.product_id.id)
    ...
    def compute_landed_cost(self):
        ...
        towrite_dict = {}
        print("//////////////", self._get_targeted_move_ids())
        for cost in self.filtered(lambda cost: cost._get_targeted_move_ids()):
            ...
            for val_line_values in all_val_line_values:
                ...
                total_line += 1
            print("/cost.cost_lines", cost.cost_lines  )
            for line in cost.cost_lines:
                value_split = 0.0
                for valuation in cost.valuation_adjustment_lines:
                    value = 0.0
                    if valuation.cost_line_id and valuation.cost_line_id.id == line.id:
                        print("///////////", line.split_method, total_duty, )
